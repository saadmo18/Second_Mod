...
public class bluesheepEntity extends AnimalEntity {
    private static final TrackedData<Boolean> ATTACKING =
            DataTracker.registerData(bluesheepEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public bluesheepEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createbluesheepAttributes(){
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.BLUESHEEP.create(world);
    }
